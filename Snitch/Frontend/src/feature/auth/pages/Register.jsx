...
export default function Register() {
  ...
  const onSubmit = (e) => {
    e.preventDefault();
      const success =  registerHandler(form);
        ...
        <div className="flex-1 flex items-center justify-center px-6 sm:px-10 py-8">
          <div className="w-full max-w-90 space-y-6">
            ...
            <form onSubmit={onSubmit} noValidate className="space-y-3.5">
              ...
              <label
                htmlFor="isSeller"
                className="flex items-start gap-3 cursor-pointer group pt-0.5 select-none"
              >
                <div className="mt-0.5 shrink-0">
                  ...
                  >
                    {form.isSeller && <CheckMark />}
                  </div>
                </div>
                <div>
                  <p className="text-zinc-300 text-[13px] font-medium leading-tight">
                    Register as Seller
                  </p>
                  <p className="text-zinc-600 text-[11px] mt-0.5 leading-snug">
              ...
              <button
                ...
                type="submit"
                className="group relative w-full mt-1 bg-white text-black text-[12px] font-bold
